...
{$R-}
{
  ...
  How to install
  ----------------
  Add the path to BASSFPC.PP to your UNIT search paths; and make sure BASS.DLL
  is present in your executable's home directory or in the system path.

  FreePascal
  ----------

  Ported to FreePascal by Lawrence Curwood, 2004/02/22.
  Please report FPC specific bugs to lawrence@paradicesoftware.com
}
